  ...
  const schemes: SchemeItem[] = [
    {
      ...
      objectives: ["Financial assistance up to ₹2.5 Lakhs", "Subsidized bank loan interest rates", "Preference to female heads of household"],
      logoSvg: (
        <svg className="w-20 h-20" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M50 14 L50 17 M50 31 L50 34 M38 24 L41 24 M59 24 L62 24 M42 16 L44 18 M58 30 L56 28 M42 32 L44 30 M58 16 L56 18" stroke="#F59E0B" strokeWidth="1.5" />
        </svg>
      ),
    },
    {
      ...
      objectives: ["Daily door-to-door garbage separation", "Elimination of open-defecation areas", "Bio-degradable composting facilities"],
      logoSvg: (
        <svg className="w-20 h-20" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="50" cy="50" r="46" stroke="#E2E8F0" strokeWidth="2" fill="#F8FAFC" />
          {/* Glasses */}
          ...
          {/* Text inside glasses */}
          <text x="36" y="54" fontSize="10" fontWeight="900" fontFamily="sans-serif" fill="#134074" textAnchor="middle">स्वच्छ</text>
          <text x="64" y="54" fontSize="10" fontWeight="900" fontFamily="sans-serif" fill="#2E7D32" textAnchor="middle">भारत</text>
    ...
    },
    {
      ...
      objectives: ["Self-employment group configurations", "Skill training certifications", "Shelters for urban homeless families"],
      logoSvg: (
        <svg className="w-20 h-20" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="50" cy="50" r="46" stroke="#E2E8F0" strokeWidth="2" fill="#F8FAFC" />
          <circle cx="50" cy="50" r="40" stroke="#E07A1D" strokeWidth="1.5" />
          {/* Hands / Petals layout */}
          <path d="M50 25 C45 35, 35 45, 25 50 C35 55, 45 65, 50 75 C55 65, 65 55, 75 50 C65 45, 55 35, 50 25 Z" fill="#134074" opacity="0.15" />
    ...
    },
    {
      ...
      objectives: ["55 Liters potable water per person daily", "Water quality testing lab setups", "Grey-water re-usage mechanisms"],
      logoSvg: (
        <svg className="w-20 h-20" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="50" cy="50" r="46" stroke="#E2E8F0" strokeWidth="2" fill="#F8FAFC" />
          {/* Water drop shape */}
          <path d="M50 25 C50 25, 66 43, 66 57 C66 67, 58 75, 50 75 C42 75, 34 67, 34 57 C34 43, 50 25, 50 25 Z" fill="#0EA5E9" />
          ...
          <text x="50" y="70" fontSize="5" fontWeight="bold" fill="#FFFFFF" textAnchor="middle">Har Ghar Jal</text>
        </svg>
      ),
    },
  ];
          ...
          {schemes.map((scheme, idx) => (
            ...
            >
              <div className="flex flex-col items-center">
                {/* SVG circular Logo */}
                <div className="mb-6 transition-transform group-hover:scale-105 duration-300">
                  {scheme.logoSvg}
                </div>
              ...
              <div className="w-full mt-6 pt-4 border-t border-slate-50 space-y-4">
                <div className="space-y-1.5 text-left hidden group-hover:block animate-fade-in">
                  ...
                  {scheme.objectives.map((obj) => (
                    <div key={obj} className="flex items-center gap-1.5 text-[10px] text-slate-600 font-bold leading-normal">
        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-md flex flex-col md:flex-row gap-6 items-center">
          ...
          <div className="space-y-1 text-center md:text-left flex-1">
            ...
            <p className="text-xs text-slate-500 font-semibold leading-relaxed">
              If you fall under the low-income ceiling (EWS/LIG) and require direct guidance to register for Awas or Livelihood grants, please schedule an appointment at the Town Hall Public Helpdesk.
            </p>
          </div>
          <a
            href="/contact-us"
