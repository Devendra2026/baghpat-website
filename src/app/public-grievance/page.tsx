...
import { AlertCircle, ShieldAlert, Send, FileCheck, CheckCircle2, ArrowRight } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs md:text-sm text-slate-600 leading-relaxed font-semibold">
                Baghpat Nagar Palika Parishad is committed to delivering a responsive and responsible grievance redressal ecosystem. Citizens are encouraged to report issues related to sanitation, water supply, drainage, street lighting, road maintenance, garbage collection, stray animals, illegal encroachments, property tax disputes, and any civic discomfort affecting daily life.
              </p>
              <p className="text-xs md:text-sm text-slate-600 leading-relaxed font-medium">
                Each grievance registered is tracked through a structured monitoring system ensuring timely resolution by the concerned department. Our aim is to strengthen public trust by promoting accountability, transparency, and efficient service delivery.
              </p>
              <p className="text-xs md:text-sm text-slate-600 leading-relaxed font-medium">
                Click the button below to submit your grievance. Your participation helps us build a cleaner, safer, and more citizen-friendly Baghpat.
              </p>
            </div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5 }}
            className="rounded-3xl overflow-hidden shadow-xl border border-slate-100 relative group min-h-[350px] lg:min-h-auto bg-slate-900"
          >
        ...
        <div id="grievance-form-section" className="bg-white rounded-3xl border border-slate-100 shadow-xl overflow-hidden">
          <div className="gov-gradient-blue text-white px-8 py-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-300 font-bold">Please fill in correct details. False complaints are subject to legal checks.</p>
            </div>
          </div>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-xs text-slate-500 font-semibold leading-relaxed">
                    Thank you, <span className="text-gov-blue-dark font-black">{formData.name}</span>. Your complaint is submitted. Your Tracking Code is:
                  </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-xs focus:outline-gov-blue-medium font-semibold bg-white"
                      >
                        <option value="">-- Select Category --</option>
                        <option value="Sanitation">Sanitation / Garbage Dumping</option>
                        <option value="Water Supply">Water Supply / Pipeline Leakage</option>
                        <option value="Roads">Potholes / Damaged Roadways</option>
                        <option value="Streetlights">Street Lights Malfunction</option>
                        <option value="Encroachments">Illegal Encroachment</option>
                        <option value="Other">Other Administrative Issues</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Select Municipal Ward</label>
                      <select
                        required
                        name="ward"
                        value={formData.ward}
                      ...
                      >
                        ...
                        {Array.from({ length: 11 }, (_, i) => (
                          <option key={i + 1} value={`Ward ${i + 1}`}>Ward No. {i + 1}</option>
                        ))}
                      </select>
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Incident Landmark / Address</label>
                    <input
                      required
                      type="text"
                      name="address"
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Detailed Description of Grievance</label>
                    <textarea
                      required
                      name="details"
                  ...
                  <div className="flex items-center gap-2.5 bg-amber-50 border border-amber-200 p-4 rounded-xl text-xs font-semibold text-amber-800">
                    ...
                    <span>Before submitting, please review all inputs. Reference tickets are logged directly into the Chief Officer's dashboard for verification audits.</span>
                  </div>

                  <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                    <button
                      type="button"
                      onClick={() => setFormData({ name: "", email: "", phone: "", category: "", ward: "", details: "", address: "" })}
