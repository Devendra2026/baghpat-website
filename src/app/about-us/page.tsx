...
import { Quote, Eye, Target, Award, Calendar } from "lucide-react";
import { motion } from "framer-motion";

// Types for tab state tracking per officer
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start border-b border-slate-200/60 pb-16 last:border-0 last:pb-0">
      ...
      <div className="lg:col-span-4 flex flex-col items-center w-full">
        ...
        >
          ...
          {/* Name Details */}
          <h3 className="text-lg font-black text-gov-blue-dark tracking-tight leading-tight">
            {data.name}
          </h3>
          <p className="text-xs font-bold text-gov-saffron uppercase tracking-widest mt-1">
            {data.designation}
          </p>
      ...
      <div className="lg:col-span-8 w-full">
        <div className="bg-white rounded-2xl border border-slate-100 shadow-lg p-6 md:p-8 min-h-[380px] flex flex-col justify-between">
            ...
            {activeTab === "vision" && (
              ...
              >
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                  {data.visionPoints.map((item, idx) => (
            ...
            {activeTab === "mission" && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
                  {data.missionTargets.map((item, idx) => (
          ...
          <div className="border-t border-slate-100 pt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 text-xs font-bold text-slate-500">
            ...
            <div className="text-right sm:border-l sm:border-slate-200 sm:pl-4">
              ...
              <p className="text-[10px] text-slate-400 uppercase tracking-widest mt-0.5">Government Registry Approved</p>
            </div>
          </div>
  ...
  const leadersData: OfficerRowProps[] = [
    {
      ...
      welcomeQuote: "Dear citizens of Baghpat, we are dedicated to transforming our historic municipality into a benchmark of modern urban governance.",
      welcomeText1: "Our vision is built around providing clean, automated, and hassle-free civic infrastructure. With the introduction of our unified digital desk, we want every citizen to obtain birth certificates, submit building layouts, and pay municipal taxes from their phones.",
      welcomeText2: "We urge all residents to active participate in the Swachh Bharat campaigns. A clean town promotes healthy families. Together, we can make Baghpat Nagar Palika Parishad an exemplary smart town in Western Uttar Pradesh.",
      visionTitle: "Vision 2030 Roadmap",
      visionDesc: "Baghpat Nagar Palika aims to establish a carbon-neutral administrative structure by optimizing water conservation, solid waste segregation, and maximizing public solar infrastructures.",
      visionPoints: [
      ...
      missionDesc: "Our immediate mission is to construct responsive municipal desks that solve problems efficiently. We have benchmarked our services to resolve civic complaints under 72 hours.",
      missionTargets: [
    ...
    },
    {
      ...
      welcomeQuote: "Ensuring transparency, accountability, and execution of government welfare schemes with maximum efficiency is our top priority.",
      welcomeText1: "The administration is focused on executing policies smoothly. We are transforming manual record-keeping into a robust digital framework to minimize delays and eliminate bureaucracy.",
      welcomeText2: "Every municipal fund is being streamlined for optimal development. Our officers are working round-the-clock on the ground to monitor sanitation and civil constructions.",
      visionTitle: "Administrative Excellence",
      visionDesc: "To create an agile, paperless municipal administration that serves as a single-window clearance portal for citizens and commercial stakeholders.",
      visionPoints: [
      ...
      missionDesc: "To strictly implement urban development blueprints, maximize revenue collection fairly, and ensure seamless coordination between public representatives and executives.",
      missionTargets: [
    ...
    },
    {
      ...
      welcomeQuote: "We act as the core backbone of Town Panchayat daily operations, documenting data and ensuring proper verification of all public registries.",
      welcomeText1: "From birth certificates to commercial licensing permissions, our clerical desk ensures all paperwork adheres strictly to state regulations, leaving zero room for errors.",
      welcomeText2: "We are committed to helping citizens who visit the town hall. Our desk-level staff is being upskilled regularly to behave courteously and fast-track your applications.",
      visionTitle: "Flawless Record Governance",
      visionDesc: "To migrate decades of old physical public registries into fully accessible, secure cloud databases with zero data loss or discrepancies.",
      visionPoints: [
      ...
      missionDesc: "Our daily objective is to maintain error-free record keeping, process citizen applications without internal delay, and manage internal municipal workflows.",
      missionTargets: [
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="space-y-16">
          {leadersData.map((leader, index) => (
            <OfficerRow key={index} data={leader} />
          ))}
        </div>
