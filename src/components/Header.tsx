              ...
              {activeModal === "complaint" && (
                <form onSubmit={(e) => { e.preventDefault(); alert("Grievance ticket created! Check SMS for ticket ID."); closeModal(); }} className="space-y-4">
                  ...
                  <div>
                    ...
                    <select required className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-gov-blue-medium bg-white">
                      <option value="">-- Select Category --</option>
                      <option value="water">Water supply leakage/clogging</option>
                      <option value="sanitation">Garbage collection failure</option>
                      <option value="pothole">Road repair / Potholes</option>
                      <option value="streetlights">Street light malfunction</option>
                      <option value="other">Other Administrative queries</option>
                    </select>
                  </div>
                  <div>
              ...
              {activeModal === "paytax" && (
                <form onSubmit={(e) => { e.preventDefault(); alert("Redirecting to secured State Treasury gateway..."); closeModal(); }} className="space-y-4">
                  ...
                  <div>
                    ...
                    <select required className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-gov-blue-medium bg-white">
                      <option value="property">Property / House Tax</option>
                      <option value="water">Water Tax</option>
                      <option value="sewer">Sewerage Fee</option>
                      <option value="trade">Trade License Fee</option>
                    </select>
                  </div>
                  <div>
