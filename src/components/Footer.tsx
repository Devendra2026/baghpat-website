      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 pt-2">
            {/* <a href="#" className="w-7 h-7 rounded-full bg-white/5 hover:bg-gov-saffron hover:text-white flex items-center justify-center transition-colors" aria-label="Facebook">
              <Facebook className="w-3.5 h-3.5" />
            </a>
            <a href="#" className="w-7 h-7 rounded-full bg-white/5 hover:bg-gov-saffron hover:text-white flex items-center justify-center transition-colors" aria-label="Twitter">
              <Twitter className="w-3.5 h-3.5" />
            </a>
            <a href="#" className="w-7 h-7 rounded-full bg-white/5 hover:bg-gov-saffron hover:text-white flex items-center justify-center transition-colors" aria-label="Instagram">
              <Instagram className="w-3.5 h-3.5" />
            </a>
            <a href="#" className="w-7 h-7 rounded-full bg-white/5 hover:bg-gov-saffron hover:text-white flex items-center justify-center transition-colors" aria-label="YouTube">
        ...
        <div>
          ...
          <ul className="space-y-3.5 text-xs font-semibold">
            ...
            <li className="flex items-center gap-2.5 bg-white/5 border border-white/10 px-3 py-2 rounded-lg">
              <ShieldCheck className="w-5 h-5 text-gov-saffron shrink-0 animate-pulse" />
              <div className="leading-tight">
                <span className="text-[9px] text-slate-400 block font-bold">HELPLINE NUMBER</span>
                <a href="tel:18001804040" className="text-xs font-black text-white hover:underline">
                  1800-180-4040
                </a>
              </div>
            </li>
