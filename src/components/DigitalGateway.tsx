...
import { HardHat, Coins, Droplet, Trash2, HeartPulse, Hammer, ArrowRight } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {departments.map((dept, index) => (
            ...
            >
              <div>
                {/* Header Icon Card */}
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${dept.color} text-white flex items-center justify-center shadow-md group-hover:scale-110 transition-transform`}>
                  {dept.icon}
                </div>
