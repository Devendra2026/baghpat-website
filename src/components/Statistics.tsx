...
import { Users, Landmark, Wrench, GlassWater, MessageSquare } from "lucide-react";
    ...
    <section className="relative py-16 bg-gov-blue-dark text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <path d="M 0 100 Q 300 200 600 50 T 1200 150" fill="none" stroke="white" strokeWidth="2" strokeDasharray="10 5" />
          <path d="M 0 150 Q 400 50 800 120 T 1200 80" fill="none" stroke="white" strokeWidth="1" strokeDasharray="5 5" />
        </svg>
      </div>
