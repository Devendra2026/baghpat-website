...
import { Newspaper, Bell, FileDown, Calendar, ArrowRight, CheckSquare } from "lucide-react";
  ...
  const newsList: NewsItem[] = [
    {
      ...
      date: "June 20, 2026",
      category: "Awards",
      summary: "Under the Swachh Bharat Mission (U), Baghpat municipal administration received special appreciation for implementing daily wet-waste composting.",
    ...
    },
    {
      ...
      summary: "Citizens can now map their plots, compute their rebates, and print official receipts through the unified UP State payment gateway.",
    ...
    },
    {
      ...
      summary: "In accordance with State Net-Zero goals, a 50kW solar panel canopy has been integrated, reducing municipal utility costs by 40%.",
                ...
                >
                  ...
                  <div className="flex flex-col justify-between py-1 flex-1">
                    <div>
                      ...
                      <p className="text-[10px] text-gov-saffron font-serif font-semibold mt-0.5">
                        {news.titleHi}
                      </p>
