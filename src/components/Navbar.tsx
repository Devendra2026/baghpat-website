...
export default function Navbar() {
  ...
  return (
    ...
    >
                ...
                {item.hasDropdown && item.megaMenuType && isDropdownOpen && (
                  <div className="fixed left-0 right-0 top-[inherit] mx-auto max-w-7xl px-4 z-50">
                    <div className="bg-white border border-slate-100 rounded-xl shadow-2xl p-6 grid grid-cols-3 gap-6 animate-scale-up mt-1">
                      {/* Left highlight box */}
                      <div className="bg-gradient-to-br from-gov-blue-dark to-gov-blue-medium text-white p-5 rounded-lg flex flex-col justify-between text-left">
                        <div>
      ...
      {isOpen && (
        <div className="fixed inset-0 top-[52px] bg-slate-900/60 backdrop-blur-xs z-40 lg:hidden" onClick={() => setIsOpen(false)}>
          <div
