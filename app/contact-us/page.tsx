    ...
    <div className="bg-slate-50 min-h-screen py-16 px-4 md:px-8">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-gov-blue-dark tracking-tight font-serif">Get in Touch</h1>
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="bg-white rounded-3xl border border-slate-100 shadow-xl p-8 md:p-10 flex-1 flex flex-col justify-between">
              <div>
                ...
                <p className="text-xs text-slate-400 font-semibold mb-8">Our team will get back to you shortly.</p>
