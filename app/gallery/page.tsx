              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <p className="text-[9px] text-amber-600 font-serif font-semibold">{item.titleHi}</p>
          ...
          >
            ...
            >
              ...
              <div className="p-6 md:p-8 space-y-3 bg-white">
                ...
                <h2 className="text-base md:text-lg font-black text-slate-900 leading-snug">{activePhoto.title}</h2>
                <p className="text-xs text-amber-600 font-serif font-semibold">{activePhoto.titleHi}</p>
                <p className="text-xs text-slate-500 font-medium leading-relaxed pt-1">{activePhoto.desc}</p>
              </div>
            </m.div>
          </div>
        )}
